...
import generateSocietyContract from '@src/config/generateSocietyContract';
...
const SocietyContractForm: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (validateForm()) {
            setIsLoading(true);
            setTimeout(() => {
                const contract = generateSocietyContract(formData);
        ...
        <div className="px-6 rounded-lg">
            ...
            <form onSubmit={handleSubmit} className=" h-[80vh] overflow-y-scroll">
                ...
                <button
                    ...
                    disabled={isLoading}
                >
                    {isLoading ? 'Procesando...' : 'Crear Contrato de Sociedad'}
                </button>
            </form>

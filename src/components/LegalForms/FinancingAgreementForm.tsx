...
import generateFinancingAgreement from '@src/config/generateFinancingAgreement';
...
const FinancingAgreementForm: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (validateForm()) {
            setIsLoading(true);
            setTimeout(() => {
                const contract = generateFinancingAgreement(formData);
        ...
        <div className="px-6 rounded-lg">
            ...
            <form onSubmit={handleSubmit} className='h-[80vh] overflow-y-scroll'>
                ...
                <button
                    ...
                    disabled={isLoading}
                >
                    {isLoading ? 'Procesando...' : 'Crear Convenio de Financiación'}
                </button>
            </form>

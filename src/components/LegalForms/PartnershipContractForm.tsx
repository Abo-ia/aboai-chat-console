...
import generatePartnershipContract from '@src/config/generatePartnershipContract';
...
const PartnershipContractForm: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (validateForm()) {
            setIsLoading(true);
            setTimeout(() => {
                const contract = generatePartnershipContract(formData);
        ...
        <div className="px-6 rounded-lg h-[80vh] overflow-y-scroll">
            ...
            <form onSubmit={handleSubmit} className=" h-[80vh] overflow-y-scroll">
                ...
                <button
                    ...
                    disabled={isLoading}
                >
                    {isLoading ? 'Procesando...' : 'Crear Contrato de Asociación'}
                </button>
            </form>

...
const ComplaintsForm: React.FC = () => {
    const [formData, setFormData] = useState({
        ...
        direccionDenunciado:
            'Av. Siempre Viva 742, Colonia Industrial, Guadalajara, Jalisco, CP 44100',
        ...
        descripcionHechos:
            'El denunciado, Carlos López Martínez, realizó acciones de hostigamiento verbal y físico hacia el denunciante, Juan Pérez López, en el lugar de trabajo. Estos eventos se registraron en presencia de varios testigos. El incidente incluyó amenazas directas que generaron un ambiente de intimidación.',
    });
                ...
                <section className="mb-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <label className="block">
                            ...
                            <input
                                type="date"
                                name="fechaNacimientoDenunciante"
                                value={formData.fechaNacimientoDenunciante}
                                onChange={handleInputChange}
                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                            />
                        </label>
                        ...
                        <label className="block col-span-2">
                            ...
                            <input
                                ...
                                value={formData.direccionDenunciante}
                                onChange={handleInputChange}
                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                            />
                        </label>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <label className="block">
                            <span className="text-gray-700">
                                Nombre Completo del Denunciado o Entidad
                            </span>
                            <input
                                type="text"
                        ...
                        <label className="block">
                            ...
                            <input
                                type="text"
                                name="aliasDenunciado"
                                value={formData.aliasDenunciado}
                                onChange={handleInputChange}
                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                            />
                        </label>
                        <label className="block">
                            ...
                            <input
                                type="date"
                                name="fechaNacimientoDenunciado"
                                value={formData.fechaNacimientoDenunciado}
                                onChange={handleInputChange}
                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                            />
                        </label>
                        <label className="block">
                            ...
                            <input
                                type="text"
                                name="identificacionDenunciado"
                                value={formData.identificacionDenunciado}
                                onChange={handleInputChange}
                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                            />
                        </label>
                        ...
                        <label className="block">
                            ...
                            <input
                                type="email"
                                name="correoDenunciado"
                                value={formData.correoDenunciado}
                                onChange={handleInputChange}
                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                            />
                        </label>
                        <label className="block col-span-2">
                            ...
                            <input
                                type="text"
                                name="relacionDenunciante"
                                value={formData.relacionDenunciante}
                                onChange={handleInputChange}
                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                            />
                        </label>
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white rounded-lg p-6 max-w-2xl w-full h-[70vh] overflow-y-auto">
                        ...
                        <p className="mb-4 text-gray-700 text-center">
                            Esta funcionalidad ayuda a desarrollar la sección "Descripción de los
                            Hechos" generada con base en los datos recabados. Asegúrate de revisar y

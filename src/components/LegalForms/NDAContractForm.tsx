...
import generateNDAContract from '@src/config/generateNDAContract';
...
const NDAContractForm: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (validateForm()) {
            ...
            setTimeout(() => {
                const contract = generateNDAContract(formData);
        ...
        <div className="px-6 rounded-lg">
            ...
            <form onSubmit={handleSubmit} className=" h-[80vh] overflow-y-scroll">
                ...
                <button
                    ...
                    disabled={isLoading}
                >
                    {isLoading ? 'Procesando...' : 'Crear Contrato de Confidencialidad (NDA)'}
                </button>
            </form>

                ...
                <div className="flex items-center justify-center gap-10">
                    <div>
                        ...
                        <p className="text-gray-500 mt-2">
                            Conoce a las personas que hacen posible que nuestra empresa siga
                            creciendo.
                        </p>
                    </div>
                    <button
                        ...
                        <div key={index} className="text-center text-gray-500 dark:text-gray-400">
                            ...
                            <ul className="flex justify-center mt-4 space-x-4">
                                <li>
                                    <a
                                        href="#"
                                        className="text-[#39569c] hover:text-gray-900 dark:hover:"
                                    >
                                        <svg
                                            className="w-6 h-6"
                                            fill="currentColor"
                                ...
                                <li>
                                    <a
                                        href="#"
                                        className="text-[#00acee] hover:text-gray-900 dark:hover:"
                                    >
                                        <svg
                                            className="w-6 h-6"
                                            fill="currentColor"
                                ...
                                <li>
                                    <a
                                        href="#"
                                        className="text-gray-900 hover:text-gray-900 dark:hover: dark:text-gray-300"
                                    >
                                        <svg
                                            className="w-6 h-6"
                                            fill="currentColor"
                                ...
                                <li>
                                    <a
                                        href="#"
                                        className="text-[#ea4c89] hover:text-gray-900 dark:hover:"
                                    >
                                        <svg
                                            className="w-6 h-6"
                                            fill="currentColor"

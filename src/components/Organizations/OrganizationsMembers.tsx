...
const OrganizationMembers = () => {
    ...
    return (
        <section className="bg-white overflow-y-auto h-[60vh]">
            <div className="py-4 px-4 mx-auto max-w-screen-xl text-center lg:py-10 lg:px-6">
                <div className="mx-auto mb-8 max-w-screen-sm lg:mb-10">
                    <h2 className="mb-2 text-2xl tracking-tight font-extrabold text-gray-900 dark:">

    ...
    const promotions = [
        {
            ...
            title: 'Envío gratis',
            description:
                'Tienes 3 meses para probar el envío gratis y ofertas exclusivas de Genius.',
        ...
        },
        {
            ...
            title: '-10% Extra',
            description:
                'Obtienes un 10% extra al comprar este producto, en pedidos de al menos $100.',
    ...
    return (
        <div className="grid grid-cols-1 gap-4">
            {promotions.map((promo) => (
                <div
                    key={promo.id}
                    className="border rounded-lg p-4 flex items-start gap-4 bg-gray-50"
                >
